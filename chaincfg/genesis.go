...
// facNetGenesisMerkleRoot is the hash of the first transaction in the genesis
// block for the fac network.  It is the same as the merkle root for
// the main network.
var facNetGenesisMerkleRoot = genesisMerkleRoot

// facNetGenesisBlock defines the genesis block of the block chain which serves
// as the public transaction ledger for the fac network.
var facNetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version:      1,
		PrevBlock:    chainhash.Hash{},
		MerkleRoot:   facNetGenesisMerkleRoot,
		StakeRoot:    chainhash.Hash{},
		Timestamp:    time.Unix(1555056000, 0), // Mon, 08 Feb 2016 18:00:00 GMT
...
// facNetGenesisHash is the hash of the first block in the block chain for the
var facNetGenesisHash = facNetGenesisBlock.BlockHash()
