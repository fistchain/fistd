...
var (
	dcrdHomeDir            = dcrutil.AppDataDir("fistd", false)
	dcrctlHomeDir          = dcrutil.AppDataDir("fistctl", false)
	dcrwalletHomeDir       = dcrutil.AppDataDir("dcrwallet", false)
	defaultConfigFile      = filepath.Join(dcrctlHomeDir, "fistctl.conf")
...
// config defines the configuration options for fistctl.
//
